...
const Card = ({icon, category, top, left, spent, split, total, comment}: 
				{icon: string,
				category: string,
				top: number,
				left: number,
	...
	if (split) {
		return (
			<div className={cardParentClassList.join(' ')} style={{top: `${top}px`, left: `${left}px`}}>
				...
				<p className="pl-[15px] pr-[5px] py-[10px] leading-5 font-normal block relative w-full rounded-xl rounded-tl-none bg-[#5E5E5F]
